...
DAT.Globe = function (container, opts) {
    ...
    function init() {
        ...
        windowHeight = (container.offsetHeight || window.innerHeight) - 75;
    ...
    function latLonToVector3(lat, lon, height) {
        ...
        //vector3.x = -200 * Math.cos(LAT) * Math.cos(LON);
        //vector3.y = 200 * Math.sin(LAT);
        //vector3.z = 200 * Math.cos(LAT) * Math.sin(LON);
